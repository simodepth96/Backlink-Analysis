...
if uploaded_file and model_choice:
    ...
    with tab6:
        ...
        if len(df_filtered) == 0:
            ...
            lowest_ur = df_filtered.nsmallest(25, 'UR', keep='first')
            fig1 = px.bar(
            ...
            lowest_cosine = df_filtered.nsmallest(25, 'Cosine Similarity', keep='first')
            fig3 = px.bar(
            ...
            lowest_cas = df_filtered.nsmallest(25, 'Contextual Authority Score', keep='first')
            fig4 = px.bar(
